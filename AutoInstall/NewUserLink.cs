...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s for the attribute 'Title' to contain the specified value 'Article List'. Associated repository item: 'GoogleChrome.Tab'", repo.GoogleChrome.TabInfo, new RecordItemIndex(4));
            repo.GoogleChrome.TabInfo.WaitForAttributeContains(5000, "Title", "Article List");
            
            // E.6
            Report.Log(ReportLevel.Info, "Validation", "E.6\r\nValidating AttributeRegex (Title~'Article List') on item 'GoogleChrome.Tab'.", repo.GoogleChrome.TabInfo, new RecordItemIndex(5));
            Validate.AttributeRegex(repo.GoogleChrome.TabInfo, "Title", new Regex("Article List"));
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Ctrl+W' Press.", new RecordItemIndex(7));
            Keyboard.Press(System.Windows.Forms.Keys.W | System.Windows.Forms.Keys.Control, 17, Keyboard.DefaultKeyPressTime, 1, true);
            Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'GoogleChrome.Pane' at 1893;7.", repo.GoogleChrome.PaneInfo, new RecordItemIndex(8));
