...
#region Variables
        ...
        /// </summary>
        [TestVariable("fb2bb8d4-247d-473a-b21a-8489ceef64e4")]
        ...
        void ITestModule.Run()
        {
            ...
            // B.3
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nB.3\r\nValidating AttributeRegex (Text~$currentVersion) on item 'HeavyBidServerSetup.TextContainersForValidation.Titlebar'.", repo.HeavyBidServerSetup.TextContainersForValidation.TitlebarInfo, new RecordItemIndex(3));
