...
{
    public partial class ValidateChiefEstimatorOutput
    {
       	/// <summary>
        ...
        string filePath_Expected = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\Reference\ChiefEstimatorAnalysisReportSimiliarContent.txt";
    	string filePath_Current = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\ChiefEstimatorAnalysisReportSimiliarContent.txt";
        ...
        private void Init()
        {
 		...
 		public void ChiefEstimatorExists()
        {
        ...
        public void ValidateContentChiefEstimator()
        {
            string path = Path.Combine(dir,file);
