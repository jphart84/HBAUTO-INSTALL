...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable currentYear.
        /// </summary>
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeRegex (Text~$currentYear) on item 'HBPopUpScreens.FromHelpButtons.WelcomeToHeavyBidScreen.Titlebar'.", repo.HBPopUpScreens.FromHelpButtons.WelcomeToHeavyBidScreen.TitlebarInfo, new RecordItemIndex(3));
                Validate.AttributeRegex(repo.HBPopUpScreens.FromHelpButtons.WelcomeToHeavyBidScreen.TitlebarInfo, "Text", new Regex(currentYear), null, false);
                Delay.Milliseconds(0);
