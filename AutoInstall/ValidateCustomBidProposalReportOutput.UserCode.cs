...
{
    public partial class ValidateCustomBidProposalReportOutput
    {
        /// <summary>
  ...
  //      string refDir = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\Reference\";
        ...
        string filePath_Expected = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\CustomizedBidProposalSimiliarContent.txt";
    	string filePath_Current = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\Reference\CustomizedBidProposalSimiliarContent.txt";
        ...
        private void Init()
        {
 		...
 		public void ValidateContentCustomizedBidProposal()
        {
        ...
        public void CustomizedBidProposalExists()
        {
            string path = Path.Combine(dir,file);
