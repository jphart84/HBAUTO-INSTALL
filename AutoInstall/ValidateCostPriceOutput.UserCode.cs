...
{
    public partial class ValidateCostPriceOutput
    {
        		/// <summary>
    	...
    	string filePath_Current = @"W:\HBDaily\InstallAutomation\HBReportsExportFiles\CostPriceReportSimiliarContent.txt";
        ...
        public void ValidateContentCostPrice()
        {
            string path = Path.Combine(dir,file);
