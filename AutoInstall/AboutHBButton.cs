...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeRegex (Text~$currentYear) on item 'HBPopUpScreens.FromHelpButtons.AboutHeavyBid.HBTextLine'.", repo.HBPopUpScreens.FromHelpButtons.AboutHeavyBid.HBTextLineInfo, new RecordItemIndex(2));
                Validate.AttributeRegex(repo.HBPopUpScreens.FromHelpButtons.AboutHeavyBid.HBTextLineInfo, "Text", new Regex(currentYear), null, false);
